...
import { CheckInInsert } from '@lib/supabase/types'
...
export function CheckInPageContent({ initialClientId, initialCoachId }: CheckInPageContentProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSuccess(true)
      // Use ref to prevent repeated navigation on re-renders
