...
/**
 * OSS Hero Design Safety Module Installer
 * 
...
// Configuration
const SOURCE_REPO = join(__dirname, '../../..'); // Go up from scripts/oss-hero-port/
...
class DesignSafetyInstaller {
  ...
  async run() {
    console.log('🚀 OSS Hero Design Safety Module Installer');
    console.log('==========================================\n');
  ...
  async createSelfTestWorkflow() {
    ...
    const workflowContent = `name: OSS Hero Port Self-Test
...
jobs:
  self-test:
    ...
    const workflowPath = join(TARGET_REPO, '.github/workflows/oss-hero-port-selftest.yml');
    await fs.writeFile(workflowPath, workflowContent);
    this.installedFiles.push('.github/workflows/oss-hero-port-selftest.yml');
...
- **Contract failures**: Check component prop interfaces and exports`;
  ...
  printSummary() {
    console.log('🎉 OSS Hero Design Safety Module — Installed Successfully!');
    console.log('========================================================\n');
    ...
    console.log('- Self-Test: .github/workflows/oss-hero-port-selftest.yml');
